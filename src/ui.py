...
def render_idle_panel():
    ...
    <p style="color:#9caac3;margin:0;">The app will use preset NextCure lanes, pull up to 100 registry results per lane, classify geography, enrollment, phase, forward-looking catalysts, and combination-therapy signals.</p></div>
    """, unsafe_allow_html=True)
